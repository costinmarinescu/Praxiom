  ...
  namespace Controllers {
    ...
    private:
      ...
      static constexpr ble_uuid128_t praxiomServiceUuid {
        ...
        .value = {0xd0, 0x42, 0x19, 0x3a, 0x3b, 0x43, 0x23, 0x8e, 0xfe, 0x48, 0xfc, 0x78, 0x00, 0x19, 0x00, 0x00}
      };

      // Bio-Age Characteristic UUID: 00001901-78fc-48fe-8e23-433b3a1942d0
      static constexpr ble_uuid128_t praxiomBioAgeCharUuid {
        .u = {.type = BLE_UUID_TYPE_128},
        .value = {0xd0, 0x42, 0x19, 0x3a, 0x3b, 0x43, 0x23, 0x8e, 0xfe, 0x48, 0xfc, 0x78, 0x01, 0x19, 0x00, 0x00}
      };
